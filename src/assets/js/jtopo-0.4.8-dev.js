...
function (JTopo) {
    function MessageBus(messageName) {
        ...
        this.name = messageName, this.messageMap = {}, this.messageCount = 0, this.subscribe = function (eventType, eventHandel) {
            ...
            if (null != e)
                for (var f = 0; f < e.length; f++) delay ? !
                    function (a, b) {
                        setTimeout(function () {
                            a(b)
                        }, 10)
...
function (JTopo) {
    ...
    function Stage(c) {
        ...
        q.forEach(function (a) {
            ...
            function () {
                0 == stage.frames ? setTimeout(arguments.callee, 100) : stage.frames < 0 ? (stage.repaint(), setTimeout(arguments.callee, 1e3 / -stage.frames)) : (stage.repaint(), setTimeout(arguments.callee, 1e3 / stage.frames))
            }(), setTimeout(function () {
...
function (JTopo) {
    function Scene(c) {
        ...
        var e = this;
        this.initialize = function () {
            Scene.prototype.initialize.apply(this, arguments), this.messageBus = new JTopo.util.MessageBus, this.elementType = "scene", this.childs = [], this.zIndexMap = {}, this.zIndexArray = [], this.backgroundColor = "255,255,255", this.visible = !0, this.alpha = 0, this.scaleX = 1, this.scaleY = 1, this.mode = JTopo.SceneMode.normal, this.translate = !0, this.translateX = 0, this.translateY = 0, this.lastTranslateX = 0, this.lastTranslateY = 0, this.mouseDown = !1, this.mouseDownX = null, this.mouseDownY = null, this.mouseDownEvent = null, this.areaSelect = !0, this.operations = [], this.selectedElements = [], this.paintAll = !1;
            var c = "translateX,translateY,scaleX,scaleY".split(",");
            ...
            for (var c = 0; c < this.zIndexArray.length; c++)
                for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f < e.length; f++) {
                    ...
                    if (1 == this.paintAll || this.isVisiable(g)) {
                        ...
                        1 == g.shadow && (b.shadowBlur = g.shadowBlur, b.shadowColor = g.shadowColor, b.shadowOffsetX = g.shadowOffsetX, b.shadowOffsetY = g.shadowOffsetY), g instanceof JTopo.InteractiveElement && (g.selected && 1 == g.showSelected && g.paintSelected(b), 1 == g.isMouseOver && g.paintMouseover(b)), g.paint(b), b.restore()
                    }
                }
            ...
            c && (this.zIndexMap[b.zIndex] = JTopo.util.removeFromArray(c, b)), b.removeHandler(this)
        }, this.clear = function () {
            var a = this;
            this.childs.forEach(function (b) {
                b.removeHandler(a)
            ...
            if (this.mouseDown = !0, this.mouseDownX = c.x, this.mouseDownY = c.y, this.mouseDownEvent = c, this.mode == JTopo.SceneMode.normal) this.selectElement(c), (null == this.currentElement || this.currentElement instanceof JTopo.Link) && 1 == this.translate && (this.lastTranslateX = this.translateX, this.lastTranslateY = this.translateY);
            else {
            ...
            this.stage.cursor != JTopo.MouseCursor.normal && (this.stage.cursor = JTopo.MouseCursor.normal), e.clearOperations();
            var c = this.toSceneEvent(b);
    ...
    function f(b, c, g) {
        ...
        this.initialize = function (b, c, d) {
            if (f.prototype.initialize.apply(this, arguments), this.elementType = "link", this.zIndex = a.zIndex_Link, 0 != arguments.length) {
                ...
                var e = "nodeSrc,nodeDst,lineType,text,linkParams".split(",");
    ...
    function adjustPosition(currNode, nodeChilds, event) {
        if (currNode.layout && currNode.layout.on) {
            ...
            if ("circle" == d) {
                ...
                e = n(currNode.cx, currNode.cy, nodeChilds.length, f, currNode.layout.beginAngle, currNode.layout.endAngle)
            } else if ("tree" == d) {
                var g = c.width || 50,
                    h = c.height || 50,
                    i = c.direction;
                ...
                if ("grid" != d) return;
                e = m(currNode.x, currNode.y, c.rows, c.cols, c.horizontal || 0, c.vertical || 0)
            }

            if ("auto" !== d)
                for (var j = 0; j < nodeChilds.length; j++) nodeChilds[j].setCenterLocation(e[j].x, e[j].y)
        }
    }
